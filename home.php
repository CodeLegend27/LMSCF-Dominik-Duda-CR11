...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="https://cdn.pixabay.com/photo/2016/01/01/02/01/animal-welfare-1116203_1280.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="https://cdn.pixabay.com/photo/2016/01/01/00/59/animal-welfare-1116184_1280.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="https://cdn.pixabay.com/photo/2016/01/01/02/16/animal-welfare-1116215_1280.jpg" alt="Third slide">
    </div>
  </div>
</div>
...
<div class="container-fluid">
  ...
  $sql = "SELECT * FROM animals JOIN location ON animals.id = location.id 
